                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                               <div class="text-end">
                                <a href="add_cat.php">
                                <button type="button" class="btn btn-success">Add category</button></a>
                              </div>
                                    ...
                                    <table class="table user-table no-wrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="edit.php?editid=<?php echo $row->cat_id; ?>"><button class="btn btn-success">Edit</button></a></td>
                                            </tr>
                                        </tbody>
                                        <?php }?>
                                    </table>
