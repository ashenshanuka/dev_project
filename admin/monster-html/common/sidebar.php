                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="m_doctor.php" aria-expanded="false"><i class="me-3 fa fa-user-md"
                                    aria-hidden="true"></i><span class="hide-menu">Manage Counsellors</span></a>
                        </li>
                        <!-- Manage Medical -->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="m_medical.php" aria-expanded="false"><i class="me-3 fa fa-medkit"
                                    aria-hidden="true"></i><span class="hide-menu">Manage Treatments</span></a>
                        </li>
                        <!-- Manage Blog -->
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="m_blog.php" aria-expanded="false"><i class="me-3 fa fa-pencil-alt" 
                                aria-hidden="true"></i><span class="hide-menu">Manage Blog</span></a>
                        </li>
                        <!-- Manage Patient -->
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
