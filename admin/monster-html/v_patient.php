...
$id = $_GET['u_id'];
$result = $obj->query("select * from user where u_id='$id'");
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="mt-6"> <img src="../pat_upload/<?php echo $row->image; ?>"
                                        class="rectangle" width="200">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea rows="5" class="form-control ps-0 form-control-line"><?php echo $row->address; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 border-bottom">
                                            <select class="form-select shadow-none border-0 ps-0 form-control-line">
                                                ...
                                                ?>
                                                <option value="<?php echo $c->city_id; ?>"<?php if($row->city_id== $c->city_id) echo 'selected'; ?>><?php echo $c->name; ?></option>
                                            <?php } ?>
                                            </select>
                                        </div>
                                    </div>
